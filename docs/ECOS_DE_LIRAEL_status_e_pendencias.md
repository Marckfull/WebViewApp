...
| Side quests | 🟢 | **12 quests rastreadas** com 4 tipos de objetivo (KILL, COLLECT, ESCORT, **MEMORIES**). Todas as 10 secundárias do documento (MS-1..MS-10) estão jogáveis, incluindo **O Duelo da Arena** (MS-8, derrota o Eco Maior do Ocaso) e **O Coro das Doze Memórias** (MS-10, reunir as 12 Memórias, desbloqueia o final secreto). Falta só a camada de escolhas ramificadas com consequência (hoje a escolha é narrada nos diálogos) |
