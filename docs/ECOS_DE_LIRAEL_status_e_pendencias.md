...
| Side quests | 🟡 | **7 quests rastreadas** (KILL, COLLECT, ESCORT): Casca Teimosa, Cordas que Ferem de Longe, O Que Só o Escuro Mostra, O Aço Que Falta, O Peregrino Ferido, **O Cão Sem Nome** (vila) e **As Ervas da Alquimista** (Cripta). Do documento (MS-1..MS-10), faltam implementar MS-6/7/8/9/10 |
