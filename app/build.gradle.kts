...
android {
    namespace = "com.kardiapulse.game"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.kardiapulse.game"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
    ...
    buildTypes {
        debug {
            ...
            // Google's official *test* ad units. Safe to click, never earn revenue.
        ...
        release {
            ...
            // TODO: troque pelos seus IDs reais do AdMob antes de publicar na Play Store.
            buildConfigField("String", "AD_INTERSTITIAL", "\"ca-app-pub-3940256099942544/1033173712\"")
            buildConfigField("String", "AD_REWARDED", "\"ca-app-pub-3940256099942544/5224354917\"")
            buildConfigField("String", "AD_BANNER", "\"ca-app-pub-3940256099942544/6300978111\"")
