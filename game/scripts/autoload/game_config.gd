...
func _register_actions() -> void:
	...
	_add_key_action("consumable", KEY_G, JOY_BUTTON_DPAD_DOWN)      ## usar slot de consumível (§3.5)
	_add_key_action("cycle_consumable", KEY_C, JOY_BUTTON_DPAD_LEFT) ## trocar de slot (§3.5)
