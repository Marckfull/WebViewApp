...
func _build_ui() -> void:
	...
	_add_button(_root_panel, "Continuar", Vector2(12, 44), _resume)
	_add_button(_root_panel, "Opções", Vector2(12, 82), func(): _show_options())
	_add_button(_root_panel, "Menu principal", Vector2(12, 120), _to_main_menu)
