...
const ROOMS := {
	...
	"res://scenes/world/forja_afundada.tscn": {"name": "Fornalhas", "region": "Forja Afundada"},
	"res://scenes/world/torre_atrio.tscn": {"name": "Átrio", "region": "Torre dos Ventos"},
	"res://scenes/world/torre_dos_ventos.tscn": {"name": "Ventos Altos", "region": "Torre dos Ventos"},
